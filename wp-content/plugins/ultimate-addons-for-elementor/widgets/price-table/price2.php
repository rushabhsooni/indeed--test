  ...
  <div class="pricing-table">
    <div class="plan featured" style="background: <?php echo $settings['body_bg']; ?>; border: 2px solid <?php echo $settings['header_bg']; ?>; transform: scale(1.0<?php echo $zoom; ?>);">
      <div class="header" style="<?php if ($settings['style'] == 'mega-price-table-2') { ?> background: <?php echo $settings['header_bg'];} ?>">
        <h4 class="plan-title price_title" style="font-size: <?php echo $titlesize; ?>px;color: <?php echo $settings['title_clr']; ?>; <?php if ($settings['style'] == 'mega-price-table-3') { ?> background-color: <?php echo $settings['header_bg'] ;} ?>">
